  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex flex-col items-center justify-center p-8">
      <div className="max-w-2xl mx-auto text-center space-y-8">
        <div className="relative w-64 h-64 mx-auto rounded-full overflow-hidden shadow-2xl ring-4 ring-blue-200">
          <img
        ...
        <blockquote className="text-lg text-slate-500 italic border-l-4 border-blue-400 pl-6 py-2 text-left">
